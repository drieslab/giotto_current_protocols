...
2
```{r}
remotes::install_gitub("RubD/Giotto")
library(Giotto)
```
3
```{r}
...
# Download data
getSpatialDataset(dataset = "ST_SCC", directory = data_dir, method = "wget")
...
```{r}
# normalized matrix
normalized_sc_matrix = readRDS(paste0(save_directory,”/”, “normalized_sc_matrix.RDS”))

# cell type vector
cell_type_vector = readRDS(paste0(save_directory,”/”, “cell_type_vector.RDS”))
...
spatCellPlot(gobject = my_giotto_object, 
             ...
             cow_n_col = 4, coord_fix_ratio = NULL, point_size = 1,
...
spatDeconvPlot(gobject = my_giotto_object,
               radius = 100,
               cell_color_code = #insert color choice vector here ,
               show_image = TRUE,
               return_plot = TRUE)
