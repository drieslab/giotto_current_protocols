...
# Differentially expressed genes (DEGs) - not shown in protocols paper
The following code demonstrates how to find differentially expressed genes for our spatial transcriptomic data.
...
# umap with top gene per cluster
ST_top1genes = ST_scran_markers_subclusters[, head(.SD, 1), by = 'cluster']$genes
dimGenePlot2D(gobject = my_giotto_object,
              genes = ST_top1genes, expression_values = 'scaled',
              cow_n_col = 3, point_shape = 'border', point_size = 2,
              save_param = list(save_name = 'suppfig1_dimGenePlot2D', 
                                base_width = 12, 
                                base_height = 12, 
                                save_format = 'pdf'))

# heatmap with top 3 genes per cluster
...
plotMetaDataHeatmap(gobject = my_giotto_object,
                    ...
                    save_param = list(save_name = 'suppfig2_plotMetaDataHeatmap', 
                                      base_width = 6, 
                                      base_height = 6, 
                                      save_format = 'pdf'))

# simpler method
ST_Sig_scran = unique(ST_scran_markers_subclusters[ranking <= 100]$genes) 

st_cell_type_names = unique(ST_scran_markers_subclusters$cluster)
ST_sign_list = list()
for(name in st_cell_type_names) {
  topgenes = ST_scran_markers_subclusters[cluster == name][1:100]$genes
  ST_sign_list[[name]] = topgenes
}
```

# scRNA-seq analysis (not shown in protocols paper)
The following is all the code used to process our single cell data to use for cell-type enrichment. These data from these results have already been downloaded and will be used for future steps. 
```{r}
# Create Giotto object
...
plotMetaDataHeatmap(gobject = my_scrna_object, 
                    ...
                    save_param = list(save_name = 'scRNA_seq_7_plotMetaDataHeatmap', 
                                      base_width = 6, 
                                      base_height = 6, 
                                      save_format = 'pdf'))
```
...
sign_list <- readRDS(paste0(save_directory, "sign_list.RDS"))
```
...
spatCellPlot(gobject = my_giotto_object,
             ...
             point_size = .75,
             point_shape = "no_border",
             save_param = list(save_name = 'fig13_spatCellPlot', 
                               base_width = 12, 
                               base_height = 12, 
                               save_format = 'pdf'))
```
...
spatDeconvPlot(gobject = my_giotto_object,
               ...
               alpha = 0.75,
               show_image = TRUE,
               save_param = list(save_name = 'fig14a_spatDeconvPlot', 
                                 base_width = 6, 
                                 base_height = 6, 
                                 save_format = 'pdf'))
...
spatPlot(my_giotto_object, 
         ...
         cell_color_code = my_colors,
         coord_fix_ratio = 1,
         save_param = list(save_name = 'fig15_spatPlot', 
                           base_width = 6, 
                           base_height = 6, 
                           save_format = 'pdf'))
```
...
plotStatDelaunayNetwork(gobject = my_giotto_object, 
                        ...
                        save_plot = TRUE,
                        save_param = list(save_name = 'fig16_plotStatDelaunayNetwork', 
                                          base_width = 6, 
                                          base_height = 6, 
                                          save_format = 'pdf'))
...
spatPlot(gobject = my_giotto_object, show_network = T, show_image = T,
         ...
         cell_color = "leiden_clus",
         coord_fix_ratio = 1,
         save_param = list(save_name = 'fig_17spatPlot', 
                           base_width = 6, 
                           base_height = 6, 
                           save_format = 'pdf'))
...
spatGenePlot(gobject = my_giotto_object,
             ...
             cow_n_col = 2,
             point_size = 2.5,
             save_param = list(save_name = 'fig18_spatGenePlot', 
                               base_width = 8, 
                               base_height = 6, 
                               save_format = 'pdf'))
```
...
heatmSpatialCorGenes(my_giotto_object,
                     ...
                     save_param = list(save_name = 'fig19_heatmSpatialCorGenes', 
                                       base_width = 7, 
                                       base_height = 6, 
                                       save_format = 'pdf'))
...
spatCellPlot(my_giotto_object,
             ...
             point_size = 1.5, 
             cow_n_col = 3,
             save_param = list(save_name = 'fig20_spatCellPlot', 
                               base_width = 10, 
                               base_height = 8, 
                               save_format = 'pdf'))
...
# intrinsic + extrinsic
spatPlot2D(my_giotto_object,
           cell_color = 'HMRF_k8_b.10', show_image = TRUE,
           cell_color_code = mycolors,
           point_size = 4.75,
           coord_fix_ratio = 1,
...
spatPlot2D(my_giotto_object,
           cell_color = 'HMRF_k8_b.15', show_image = TRUE,
           cell_color_code = mycolors,
           point_size = 4.75,
           coord_fix_ratio = 1,
           save_param = list(save_name = 'fig22b_spatCellPlot', 
                             base_width = 6, 
                             base_height = 6, 
                             save_format = 'pdf'))
...
spatPlot2D(my_giotto_object,
           ...
           point_size = 4.75,
           coord_fix_ratio = 1,
           save_param = list(save_name = 'fig_2c_spatCellPlot', 
                             base_width = 6, 
                             base_height = 6, 
                             save_format = 'pdf'))
```
